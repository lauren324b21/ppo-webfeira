...
<head>
    ...
    <title>Web Feira :: Área do Cliente :: Contatos</title>
</head>
            ...
            <h1>Minha Conta</h1>
                <div class="row gx-3">
                    ...
                    <div class="col-8">
                        ...
                        <button type="button" onclick="window.location.href='/confirmcadastrocontato.html'"
                                class="btn btn-lg btn-success">Alterar Contatos</button>
                    </div>
                </div>
            </div>
        </main>
