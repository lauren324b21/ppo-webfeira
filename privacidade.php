...
<head>
    ...
    <title>WebFeira :: Política de Privacidade</title>
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success border-bottom shadow-sm mb-3">
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <p>A sua privacidade é importante para nós. É política do WebFeira respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=index.php>WebFeira</a>, e outros sites que possuímos e operamos.</p>
                ...
                <h2>Política de Cookies WebFeira</h2>
                ...
                <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o WebFeira oferece no site e com caráter enunciativo, mas não limitativo:</p>
                <ul>
                    ...
                    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do WebFeira, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
                </ul>
